...
Use the terminal's \emph{change directory} command (\py{cd}) to navigate to your project folder. Simply type \py{cd}, a space, and the path (see Section~\ref{sec:paths}) to your destination:
