...
% ----------------------------------------------------------------------------
\subsection{Einstein Summation: \texttt{np.einsum}}
\label{subsec:einsum}

One of NumPy's most powerful (and often overlooked) tools is \py{np.einsum}. This function uses \emph{Einstein summation notation} to represent many common array operations using a short string of letters. It is an advanced skill to developed, and is mostly added here to let you know it exists.
